...
> Public mirror of documentation and examples for [AtendentePro](https://pypi.org/project/atendentepro/) — v0.32.1.
...
| `keywords.escalation` | **Bloco determinístico** | Forçar handoff imediato p/ Escalation |
...
| `custom_prompt_suffix` | Texto livre appendado | Regras condicionais extras sem redeploy |
