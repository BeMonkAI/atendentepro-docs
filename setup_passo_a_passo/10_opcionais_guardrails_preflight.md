...
>
> **Ver também:** [Passo 22 — SpecialistGuardrail (opt-in, v0.43.0+)](22_opcionais_specialist_guardrail.md) — alternativa multi-dimensional ao classificador binário descrito aqui. Use o Passo 22 quando precisar dos vereditos `warn` / `escalate` explícitos (medical/legal/financial advice; LGPD requests; human handoff); use este Passo 10 quando o binário `is_in_scope: bool` for suficiente e a latência de tokens contar.
