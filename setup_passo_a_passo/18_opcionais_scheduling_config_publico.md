...
Os modelos `SchedulingConfig` e `Location` agora sao acessiveis tanto no top-level quanto no namespace `atendentepro.templates`:
...
# Equivalente
from atendentepro.templates import SchedulingConfig, Location
```
