...
Caso real (tenant de consumer-insights): instrucao presente em Triage Rule 0, ausente em Flow/Answer — comportamento inconsistente em prod ate o gap ser detectado.
