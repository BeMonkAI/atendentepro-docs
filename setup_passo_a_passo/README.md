...
22. [22_opcionais_specialist_guardrail.md](22_opcionais_specialist_guardrail.md) — `SpecialistGuardrail` opt-in (v0.43.0+, PR #285) — veredito multi-dimensional (`decision`/`risk_level`/`category`/`confidence`) substituindo `is_in_scope: bool`; `detect_pii` + `classify_intent` function tools
23. [23_memory_declarativa_por_tenant.md](23_memory_declarativa_por_tenant.md) — Memoria declarativa por tenant
24. [24_opcionais_verificador_fundamentacao.md](24_opcionais_verificador_fundamentacao.md) — Verificador de fundamentacao
25. [25_opcionais_mcp.md](25_opcionais_mcp.md) — Servidores MCP como fonte de tools (`mcp_config.yaml`, opt-in, #491)
26. [26_opcionais_streaming.md](26_opcionais_streaming.md) — `POST /chat/stream` (SSE, opt-in, #492)
27. [27_opcionais_job_dispatch.md](27_opcionais_job_dispatch.md) — Despacho de jobs assíncronos (`dispatch_job`/`get_job`, opt-in, #501)
28. [SETUP_COMPLETO_COPILOT.md](SETUP_COMPLETO_COPILOT.md) — Fluxo único para colar no Copilot (todos os passos + cuidados)
